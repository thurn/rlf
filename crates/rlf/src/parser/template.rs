...
mod tests {
    ...
    fn test_literal() {
        ...
        assert_eq!(t.segments[0], Segment::Literal("Hello, world!".into()));
    }
    ...
    fn test_simple_interpolation() {
        ...
        assert_eq!(t.segments[0], Segment::Literal("Hello, ".into()));
        match &t.segments[1] {
    ...
    fn test_auto_capitalization_with_selectors() {
        ...
        match &t.segments[0] {
            Segment::Interpolation {
                ...
                assert_eq!(selectors[0], Selector::Identifier("n".into()));
            }
            _ => panic!("expected interpolation"),
        }
    }
